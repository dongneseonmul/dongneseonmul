...
**같이사요**는 함께 구매하면 더 저렴하게! 소상공인 가게를 함께 방문하고 공동구매 혜택을 받을 수 있는 혁신적인 플랫폼입니다. 
...
- **프로덕션 (Cloudflare Pages)**: https://gatchisayo.pages.dev
- **Preview 배포**: https://8a1f291e.gatchisayo.pages.dev
- **GitHub 저장소**: https://github.com/dongneseonmul/dongneseonmul
- **API 엔드포인트**: https://gatchisayo.pages.dev/api
